...
public:
	...
	void Allocate(	const TTokens&	FactoryTypeTokens,
...
template <class ObjectType>
void TStorage<ObjectType>::Allocate(const TTokens&	FactoryTypeTokens,
									size_t			szNRegistrationManagerFixedEntries,
									const TTokens&	SStorageIndexTokens)
{
	Release();
	...
	try
	{
		m_Factory.Allocate(FactoryTypeTokens);

		m_RegistrationManager.Allocate(szNRegistrationManagerFixedEntries);
